      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            child: TextButton(
              onPressed: () {
                if (!Get.find<EmployeesAddController>().loadingAdd.value) {
                  EmployeeAddFunction(context: context).validateFunction();
                }
              },
              style: ElevatedButton.styleFrom(
                  shadowColor: Colors.transparent,
              ...
              child: Obx(() {
                return (Get.find<EmployeesAddController>().loadingAdd.value)
                    ? Transform.scale(
                        scale: 0.6,
